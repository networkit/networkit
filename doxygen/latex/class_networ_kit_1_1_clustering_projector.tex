...
\mbox{\tt in}  & {\em Gcoarse} & \\
\hline
\mbox{\tt in}  & {\em Gfine} & \\
\hline
\mbox{\tt in}  & {\em fine\-To\-Coarse} & \\
\hline
\mbox{\tt in}  & {\em zeta\-Coarse} & a clustering of the coarse graph \begin{DoxyVerb}, project the clustering back to the fine graph to create a clustering of the fine graph.
\end{DoxyVerb}
 \\
\hline
