...
using AnyBinaryGraph = std::variant<
    ...
    AdjListGraph<uint8_t, uint32_t>, AdjListGraph<uint8_t, uint64_t>, AdjListGraph<uint8_t, int8_t>,
    AdjListGraph<uint8_t, int16_t>, AdjListGraph<uint8_t, int32_t>, AdjListGraph<uint8_t, int64_t>,
    AdjListGraph<uint8_t, float>, AdjListGraph<uint8_t, double>, AdjListGraph<uint16_t, uint8_t>,
    AdjListGraph<uint16_t, uint16_t>, AdjListGraph<uint16_t, uint32_t>,
    AdjListGraph<uint16_t, uint64_t>, AdjListGraph<uint16_t, int8_t>,
    AdjListGraph<uint16_t, int16_t>, AdjListGraph<uint16_t, int32_t>,
    AdjListGraph<uint16_t, int64_t>, AdjListGraph<uint16_t, float>, AdjListGraph<uint16_t, double>,
    ...
    AdjListGraph<uint32_t, int32_t>, AdjListGraph<uint32_t, int64_t>, AdjListGraph<uint32_t, float>,
    AdjListGraph<uint32_t, double>, AdjListGraph<uint64_t, uint8_t>,
    AdjListGraph<uint64_t, uint16_t>, AdjListGraph<uint64_t, uint32_t>,
    AdjListGraph<uint64_t, uint64_t>, AdjListGraph<uint64_t, int8_t>,
    AdjListGraph<uint64_t, int16_t>, AdjListGraph<uint64_t, int32_t>,
    AdjListGraph<uint64_t, int64_t>, AdjListGraph<uint64_t, float>, AdjListGraph<uint64_t, double>>;
