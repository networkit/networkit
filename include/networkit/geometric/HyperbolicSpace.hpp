...
public:
     ...
     *
     * @param hyperbolicCenter center of the hyperbolic circle, given in cartesian coordinates
     * within the poincare disk
     * @param hyperbolicRadius radius of the hyperbolic circle
     * @param euclideanCenter point to receive the center of the Euclidean circle, given in
