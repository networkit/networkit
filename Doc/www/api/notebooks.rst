...
This is accomplished by providing a Python interface to use NetworKit in an interactive Python shell. Complete workflows can be created with Jupyter Notebook - a web-based
interactive computing environment.

Example Notebooks
-----------------

We provide several example notebooks to get started with NetworKit and Jupyter Notebook.
