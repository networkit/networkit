...
.. raw:: html
  ...
  <ul>
    <li>
        ...
        <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv1"></button>
...
.. raw:: html
  ...
  <ul>
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv2"></button>
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv3"></button>
      <div id="collapseDiv3" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv4"></button>
      <div id="collapseDiv4" class="collapse">
    ...
    <li>
      ...
      and Mining</i>.
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv5"></button>
      <div id="collapseDiv5" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv6"></button>
      <div id="collapseDiv6" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv7"></button>
      <div id="collapseDiv7" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv8"></button>
      <div id="collapseDiv8" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv9"></button>
      <div id="collapseDiv9" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv10"></button>
      <div id="collapseDiv10" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv11"></button>
      <div id="collapseDiv11" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv12"></button>
      <div id="collapseDiv12" class="collapse">
  ...
  <ul>
    <li>
      ...
      To appear in <i>Proc. 22nd ACM SIGKDD Conference on Knowledge Discovery and Data Mining</i> (KDD 2016), August 2016. [<a href="http://arxiv.org/abs/1602.05866">arXiv</a>]
       <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv13"></button>
       <div id="collapseDiv13" class="collapse">
    ...
    <li>
      ...
      <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv14"></button>
      <div id="collapseDiv14" class="collapse">
    ...
    <li>
      P. Crescenzi, G. D’Angelo, L. Severini, Y. Velaj: Greedily Improving Our Own Centrality in A Network. In <i>Proc. 14th Intl. Symp. on Experimental Algorithms</i> (SEA 2015).
       ...
       <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv15"></button>
       <div id="collapseDiv15" class="collapse">
    ...
    <li>
      ...
      Symp. on Experimental Algorithms</i> (SEA 2015). LNCS 9125, pp. 205-218. Springer International Publishing, 2015. [<a href="http://arxiv.org/abs/1502.07888">arXiv</a>]
       <button type="button" class="btn-link collapsed" data-toggle="collapse" data-target="#collapseDiv16"></button>
       <div id="collapseDiv16" class="collapse">
