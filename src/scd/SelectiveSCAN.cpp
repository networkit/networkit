...
SelectiveSCAN::SelectiveSCAN(const Graph& G, NodeDistance& distMeasure, double epsilon, double mu): SelectiveCommunityDetector(G), epsilon(epsilon), mu(mu), distMeasure(&distMeasure) {
