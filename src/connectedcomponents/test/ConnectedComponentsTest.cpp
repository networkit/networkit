...
ConnectedComponentsTest::ConnectedComponentsTest() {
...
TEST_F(ConnectedComponentsTest, runByCall) {
	// construct graph
	Graph g;
...
TEST_F(ConnectedComponentsTest, runByConstructor) {
	// construct graph
	Graph g;
	for (count i = 0; i < 20; i++) {
		g.addNode();
...
TEST_F(ConnectedComponentsTest, graphWithoutEdges) {
	// construct graph
	Graph g;
	for (count i = 0; i < 20; i++) {
		g.addNode();
...
TEST_F(ConnectedComponentsTest, getComponent) {
	// construct graph
	Graph g;
	for (count i = 0; i < 20; i++) {
		g.addNode();
