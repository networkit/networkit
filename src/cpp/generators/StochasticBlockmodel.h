...
public:
	...
	* @param nBlocks		number of blocks (=k)
	...
	*/
	StochasticBlockmodel(count nNodes, count nBlocks, const std::vector<index>& membership, const std::vector<std::vector<double> >& affinity);
