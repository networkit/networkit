 ...
 */
class ConfigurationModelGenerator : public StaticDegreeSequenceGenerator {
public:
	/**
	 ...
	 */
	ConfigurationModelGenerator(const std::vector< NetworKit::count > &sequence, bool ignoreIfRealizable = false);
...
#endif // CONFIGURATIONMODELGENERATOR_H
