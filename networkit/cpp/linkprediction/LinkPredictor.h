...
public:
   ...
   * Note that there is no reordering of the results which means the prediction for nodePairs[0]
   * can be found in the return vector at index 0 and so on.
