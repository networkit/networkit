/*
 * LocalFilterAttributizer.cpp
 *
 *  Created on: 20.11.2014
 *      Author: Michael Hamann, Gerd Lindner
 */

#include "LocalFilterAttributizer.h"

namespace NetworKit {

template<typename InType>
LocalFilterAttributizer<InType>::LocalFilterAttributizer(const Graph &g, const std::vector< InType > &attribute, bool logarithmic, bool bothRequired) : graph(graph), attribute(attribute), bothRequired(bothRequired), logarithmic(logarithmic) {
}

template<typename InType>
std::vector< double > LocalFilterAttributizer<InType>::getAttribute() {
	/*
