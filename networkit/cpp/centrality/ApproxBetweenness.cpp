...
ApproxBetweenness::ApproxBetweenness(const Graph& G, double epsilon, double delta, count diameterSamples) : Centrality(G, true, false), epsilon(epsilon), delta(delta), diameterSamples(diameterSamples) {
