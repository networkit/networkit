...
namespace EPPFactory {
	 ...
	 * @param	baseAlgorithm	Algorithm ("PLP","PLM") to preprocess the communities. ensembleSize instances will be created.
	 * @param	finalAlgorithm	Algorithm ("PLP" "PLM[R]") to finish the ensemble.
	 */
