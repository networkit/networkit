...
//	MultigridSolver<MultigridHierarchy> solver(1e-6, 3, 3, hierarchyBuilder, smoother);
//
//	solver.setup(A);
...
//	GaussSeidelRelaxation smoother;
//	MatchingHierarchyBuilder hierarchyBuilder;
//	MultigridSolver<MultigridHierarchy> solver(1e-3, 3, 3, hierarchyBuilder, smoother);
//
