...
EliminationStage::EliminationStage(const CSRMatrix &P, const Vector &q, const std::vector<index> &fSet, const std::vector<index> &cSet) : P(P), q(q), fSet(fSet), cSet(cSet) {
}
