...
cdef extern from "cpp/linkprediction/LinkPredictor.h" namespace "NetworKit::LinkPredictor":
	...
	void LinkPredictor_sortByNodePair "NetworKit::LinkPredictor::sortByNodePair"(vector[pair[pair[node, node], double]]& predictions) except +
...
cdef class LinkPredictor:
	...
	def sortByNodePair(list predictions):
		...
		"""
		cdef vector[pair[pair[node, node], double]] predCopy = predictions
		LinkPredictor_sortByNodePair(predCopy)
		predictions[:] = predCopy
